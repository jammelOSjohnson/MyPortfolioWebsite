...
export const Section6: React.FC = function Section6() {
  return (
    <>
      <div
        id="Personal"
        className="xs:px-5 md:mx-0 md:w-full mx-auto my-0 relative z-0 dark:bg-black border-none dark:border-none"
      >
        <h1 className="text-black dark:text-white font-bold text-center font-bold text-2xl py-3">
        ...
        <div className="grid xs:grid-cols-2 sm:grid-cols-4 gap-4 border-none dark:border-none">
          ...
          <a
            href="https://managemycard.jncb.com/"
            target={"_blank"}
            rel="noreferrer"
            title="managemycard"
          >
          ...
          <a
            href="https://realhelpinghands.com/"
            target={"_blank"}
            rel="noreferrer"
            title="RHH"
          >
        ...
        <a
          href="https://twps.myguardiangroup.com/"
          target={"_blank"}
          rel="noreferrer"
          title="gll"
        >
        ...
        <div className="py-3 dark:border-none">
          <a
            href="https://docs.google.com/document/d/1kcbbPw5azosirUWVE_ziLeCmSXuWLjzw/edit?usp=sharing&ouid=102350862374533348303&rtpof=true&sd=true"
            title="resume"
            target={"_blank"}
            rel="noreferrer"
          >
            ...
            >
              Download CV
              <svg
                className="w-6 h-6 absolute top-1.5 right-4"
                fill="currentColor"
                viewBox="0 0 20 20"
