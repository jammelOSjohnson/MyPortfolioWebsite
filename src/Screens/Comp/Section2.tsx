...
export const Section2: React.FC = function Section2() {
    return (
        <>
            <div id="About" className="lg:w-full mx-0 my-0 relative z-0 dark:bg-black ">
                <svg 
               ...
               <p className="text-black dark:text-white max-w-screen-sm mx-auto my-3 xs:px-5 sm:px-0">
