...
export const Section4: React.FC = function Section4() {
    return (
        <>
            <div id="Personal" className="xs:px-5 md:mx-0 md:w-full mx-auto my-0 relative z-0 dark:bg-black">
                <h1 className="text-black dark:text-white font-bold">My Interests</h1>
                <div className="grid xs:grid-cols-2 sm:grid-cols-4 gap-4">
                    <div className="bg-green-400 dark:bg-black text-white rounded-md py-3">
